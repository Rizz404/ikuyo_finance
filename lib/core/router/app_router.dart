...
import 'package:ikuyo_finance/features/export/screens/export_screen.dart';
...
GoRouter createAppRouter(SupabaseAuthListenable authListenable) {
  return GoRouter(
    ...
    routes: [
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          ...
          StatefulShellBranch(
            routes: [
              GoRoute(
                name: AppRoutes.otherName,
                path: AppRoutes.otherPath,
                pageBuilder: (context, state) => AppPageTransitions.fadeThrough(
                  key: state.pageKey,
      ...
      // * Setting routes - outside shell (fullscreen)
      GoRoute(
      ...
      // * Backup routes - outside shell (fullscreen)
      GoRoute(
        name: AppRoutes.backupName,
        path: AppRoutes.backupPath,
        pageBuilder: (context, state) => AppPageTransitions.slideRight(
          key: state.pageKey,
          child: const BackupScreen(),
        ),
      ),
      // * Export routes - outside shell (fullscreen)
      GoRoute(
